...
def toss(method = "yarrow"):
    ...
    if method == "coin":         # coin method note tth or 223 is 7 or young yang 
        ...
        # method similar to "yallow-stick" need to have prob. 
        ...
        def ys_round(ys, round, debug="no"):
            ...
            ys[4] = ys[0] - ys[1]
            ys[0] = ys[0] - ys[1] - ys[4]
            if debug=="yes": printys(ys,"seperate into two")
            ys[3] = 1 
            ys[1] = ys[1] - ys[3] 
        ...
        return (ys[0]//4)                          # probability of 6/7/8/9 is 1/16 5/16 7/16 3/16

# We build in bottom to top

print("Method is yarrow \n")
